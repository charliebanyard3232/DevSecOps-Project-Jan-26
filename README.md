...
```mermaid
%%{init: {'theme': 'default', 'themeVariables': {'primaryColor': '#86efac', 'primaryTextColor': '#14532d', 'primaryBorderColor': '#15803d', 'lineColor': '#166534', 'secondaryColor': '#bbf7d0', 'tertiaryColor': '#dcfce7'}}}%%
flowchart LR
